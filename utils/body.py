    ...
    if water_ml:
        insights.append(
            Insight(
                "💧",
                "Вода и движение",
                f"Ориентир на день: {water_ml / 1000:.1f} л воды. "
                "Шаги и растяжка тоже в счёт — телу полезно двигаться".replace(".", ","),
            )
        )
    ...
    if protein_g:
        insights.append(
            Insight(
                "🏋️",
                "Белок",
                f"Ориентир: {protein_g} г белка в день. Вместе с силовыми "
                "2–3 раза в неделю это может помочь сохранить мышцы",
            )
        )
