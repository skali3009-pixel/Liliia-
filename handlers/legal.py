...
def welcome_text() -> str:
    ...
    return (
        ...
        "Что умеет:\n"
        "• распознаёт еду по фото, тексту и голосовому — считает КБЖУ сама;\n"
        "• считает твою суточную норму и ведёт дневник, воду и самочувствие;\n"
        "• подсказывает, что съесть прямо сейчас, если готовить негде;\n"
        "• считает шаги и даёт ходить командой, с общей таблицей за неделю;\n"
