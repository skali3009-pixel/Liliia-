...
# --- Музыка SCALIA ----------------------------------------------------------
# Необязательный переход на страницу артиста. Кнопка одна и стоит ровно в
# одном месте — под итогом анкеты; ни расчёт, ни меню она не трогает.
# Пустая строка выключает её целиком: недоступность чужого сервиса не должна
# ломать ничего в AURA, и убрать кнопку можно одной настройкой.
#
...
MUSIC_BUTTON = os.getenv("MUSIC_BUTTON", "🎧 Музыка SCALIA")[:32]
