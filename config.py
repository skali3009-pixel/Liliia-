...
# Ссылка на готовую команду «AURA Sync» в iCloud. Пока пусто — человек
# собирает команду руками по десяти карточкам; с адресом — устанавливает
# готовую и проходит шесть.
#
# Класть сюда можно только ту команду, внутри которой НЕТ ничьей личной
# ссылки: она общая, её увидит каждый, и чужой ключ в ней означал бы, что
# все шаги пишутся одному человеку. Личная ссылка должна спрашиваться при
# установке («Вопросы при импорте»).
SHORTCUT_URL = os.getenv("SHORTCUT_URL", "")
