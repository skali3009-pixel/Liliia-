...
> **Внимание.** Описанный ниже завод на aiogram — первая версия, отдельный бот.
> На сервере Лилии стоит **Hermes с профилями**, и туда завод ставится иначе —
> скиллом, см. `hermes-zavod/INSTALL.md`. Эта версия оставлена как рабочая
> и самодостаточная, но на её сервер ставить следует версию для Hermes.
