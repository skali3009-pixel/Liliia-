...
EXERCISE_IDS: dict[str, str] = {
    ...
    'Мягкое разглаживание области под глазами двумя пальцами': 'under_eye_two_finger_glide',
    'Массаж щёк от носа к ушам': 'cheek_glide',
    'Мягкие круговые движения на висках': 'temple_circles',
    'Массаж по линии нижней челюсти': 'jawline_glide',
    ...
    'Язык к нёбу с мягким подъёмом подбородка': 'tongue_palate_chin_lift',
