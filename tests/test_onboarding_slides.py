...
def test_the_slides_stand_where_a_person_gives_up():
    ...
    # Середина переехала вместе с анкетой: целевой вес из обязательных убран,
    # и теперь на середине стоит текущий вес — он же последний, который
    # набирают руками.
    assert "current_weight_kg=weight" in кусок[0]
