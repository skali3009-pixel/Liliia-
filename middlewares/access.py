...
OPEN_COMMANDS = {
    ...
    # Приглашение — единственный способ вернуть доступ, не заплатив. Закрыть
    # его от того, у кого срок вышел, значит оставить человеку ровно одну
    # дверь и запереть вторую, которую сами же и нарисовали.
    "/referral",
}
